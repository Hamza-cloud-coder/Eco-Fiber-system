...
export const SpinnerLoadingIndicator = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 z-50 rounded-[9px]"></div>
    ...
    <>
      ...
      `}
        ...
        <div className="absolute inset-0 overflow-hidden rounded-[9px]">
          <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 rounded-[9px]"></div>
